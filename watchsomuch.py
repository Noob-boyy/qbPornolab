...
"""watchsomuc search engine plugin for qBittorrent."""
...
class watchsomuch(object):
    ...
    name = 'watchsomuch'
    url = 'https://watchsomuch.org' # We MUST produce an URL attribute at instantiation time, otherwise qBittorrent will fail to register the engine, see #15
